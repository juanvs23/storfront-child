...
/***/ "./src/js/modulos/tabs.js":
/*!********************************!*\
  !*** ./src/js/modulos/tabs.js ***!
  \********************************/
/*! exports provided: tabsPayment */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "tabsPayment", function() { return tabsPayment; });
var tabsPayment = function tabsPayment() {
  var radioButtons = document.querySelectorAll('ul.wc_payment_methods.payment_methods.methods li input[type="radio"].input-radio'),
  ...
  if (document.querySelector('#payment')) {
    paymentContent.insertBefore(contenedorUl, document.querySelector('#payment')); //console.log( paymentContent);

    radioButtons.forEach(function (radioButton, i) {
      var li = document.createElement('li');
      li.setAttribute('id', "payment-".concat(i));
      var text = document.querySelector("label[for=\"".concat(radioButton.id, "\"]")).innerText;
      li.innerHTML = text;
      contenedorUl.append(li);
      document.querySelector("#payment-".concat(i)).addEventListener('click', function () {
        document.querySelector('.is-active').classList.remove('is-active');
        document.querySelector("#payment-".concat(i)).classList.add('is-active');
        document.querySelector("label[for=\"".concat(radioButton.id, "\"]")).click();
      });
    });
...
/* harmony import */ var _modulos_tabs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modulos/tabs */ "./src/js/modulos/tabs.js");
...
var woocommerceCheckout = document.querySelector('.woocommerce-checkout');
...
document.addEventListener('DOMContentLoaded', function () {
  //slider
  if (bannerSlider) {
    new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0___default.a(bannerSlider, {
      type: 'loop',
      autoplay: true
    }).mount();
  }
  ...
  if (kitHomeSlider) {
    new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0___default.a(kitHomeSlider, {
      type: 'loop',
      perPage: 3,
      breakpoints: {
        767: {
  ...
  if (woocommerceCheckout) {
    console.log('hola desde checkout'); //tabs

    Object(_modulos_tabs__WEBPACK_IMPORTED_MODULE_1__["tabsPayment"])();
  }
}); //sticky action
...
__webpack_require__(/*! /home/juanvs23/proyectos/php/woocommerce-theme/wp-content/themes/ztgroup-storefront-child/src/js/scripts.js */"./src/js/scripts.js");
module.exports = __webpack_require__(/*! /home/juanvs23/proyectos/php/woocommerce-theme/wp-content/themes/ztgroup-storefront-child/src/sass/styles.scss */"./src/sass/styles.scss");
